...
class DonorsControllerTest < ActionController::TestCase
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post :create, donor: { company_name: @donor.company_name, first_name: @donor.first_name, last_name: @donor.last_name, phone_number: @donor.phone_number }
    end
  ...
  test "should update donor" do
    patch :update, id: @donor, donor: { company_name: @donor.company_name, first_name: @donor.first_name, last_name: @donor.last_name, phone_number: @donor.phone_number }
    assert_redirected_to donor_path(assigns(:donor))
  end
