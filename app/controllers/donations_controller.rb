class DonationsController < ApplicationController
  ...
  private
    ...
    def donation_params
      params.require(:donation).permit(:item_description, :brand, :lot_number, :expiration_date, :fair_market_value, :mk_cost, :total_in_kind_value, :donor_id, :quantity, :inventory_id)
    end
end
